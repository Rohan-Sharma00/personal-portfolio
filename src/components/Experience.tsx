...
const experiences = [
  {
    id: "rinovea",
    company: "Rinovea Solutions",
    shortName: "Rinovea",
    role: "Software Engineer (Full Stack)",
    period: "Apr 2026 – May 2026",
    url: "#",
    points: [
      "Optimized frontend performance by improving Core Web Vitals (LCP, CLS, Lighthouse score) through lazy loading, rendering optimizations, and efficient resource management",
      "Resolved production bugs by analyzing Jira tickets, debugging complex frontend and backend issues, performing root cause analysis, and delivering stable fixes within sprint timelines",
      "Implemented new features for Loan Origination System (LOS) and Loan Management System (LMS), ensuring seamless integration without impacting existing functionality while maintaining clean, scalable, and maintainable code",
      "Developed and integrated Angular components with Node.js/Express REST APIs, collaborating on API contracts, validation, and end-to-end feature implementation",
      "Actively participated in Agile ceremonies, Jira ticket grooming, requirement discussions, code reviews, and peer collaboration to clarify business requirements and deliver production-ready solutions",
    ],
  },
  {
    id: "centralogic",
      ...
      <div className="section-container max-w-4xl relative z-10">
        ...
        >
          <h2 className="font-serif text-2xl md:text-3xl text-foreground whitespace-nowrap font-semibold">
            <span className="text-primary font-mono text-lg md:text-xl mr-2 text-glow">
              02.
            </span>
            Where I've Worked
          </h2>
